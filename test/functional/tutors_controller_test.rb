...
class TutorsControllerTest < ActionController::TestCase
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post :create, tutor: { resume: @tutor.resume, transcript: @tutor.transcript, univ_identifier: @tutor.univ_identifier, university: @tutor.university, user_id: @tutor.user_id }
    end
  ...
  test "should update tutor" do
    put :update, id: @tutor, tutor: { resume: @tutor.resume, transcript: @tutor.transcript, univ_identifier: @tutor.univ_identifier, university: @tutor.university, user_id: @tutor.user_id }
    assert_redirected_to tutor_path(assigns(:tutor))
  end
